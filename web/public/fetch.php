...
<li class="feed__entry" data-item-id="<?php echo $reverseIndex; ?>" data-is-new="<?php echo $isNew; ?>" data-item-min="<?php echo htmlentities($entry->author->name) . ' - ' . htmlentities($entry->title); ?>">
